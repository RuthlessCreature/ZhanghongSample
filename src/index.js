...
const COMMENT_SYSTEM_PROMPT=[
  ...
  "6. 如果目标图号在 pagePairs 中不存在或未进入扫描范围，优先判 uncertain，而不是 not_found。",
  "7. 对 CLR、CL、AFF 等多义缩写保持原文；除非图纸明确含义，不得自行展开。",
  "8. 不得编造规范条文或法定合规结论。这里只判断“意见是否落实”。",
  "9. 可以指出与意见无明显对应的额外变更，放入 unlistedChanges，提醒人工确认是否为授权修改。",
  "10. 只输出严格 JSON，不要 Markdown，不要代码围栏。",
  "",
  "输出 JSON：",
  "{",
