...
export default {
  async fetch(request,env){
    ...
    if(url.pathname==="/api/health")return json({ok:true,product:"Agent Hong",feature:"architectural-ai-workbench",engine:"agent-hong-v1.8",release:"phase1-productized",ui:"product-v2",modules:["version-diff","drawing-review","comment-check","history-search","reference-assistant","geotech-conditions","design-briefing"],moduleVersions:{"version-diff":"hybrid-v1","drawing-review":"precheck-v2","comment-check":"closure-v1","history-search":"local-search-v1","reference-assistant":"grounding-v1","geotech-conditions":"conditions-v1","design-briefing":"briefing-v1"},model:env.MINIMAX_MODEL||"MiniMax-M3",configured:Boolean(env.MINIMAX_API_KEY)});
